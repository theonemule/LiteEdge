...
<tr><td>Fake Bot Protection</td><td><span class="badge text-bg-success">Lua ready</span></td><td class="text-end"><a class="btn btn-sm btn-outline-primary" href="https://github.com/coreruleset/fake-bot-plugin/archive/refs/heads/main.tar.gz">Download</a></td></tr>
...
<tr><td>Antivirus Integration</td><td><span class="badge text-bg-warning">Lua ready / AV required</span></td><td class="text-end"><a class="btn btn-sm btn-outline-primary" href="https://github.com/coreruleset/antivirus-plugin/archive/refs/heads/main.tar.gz">Download</a></td></tr>
<tr><td>Body Decompression</td><td><span class="badge text-bg-success">Lua ready</span></td><td class="text-end"><a class="btn btn-sm btn-outline-primary" href="https://github.com/coreruleset/body-decompress-plugin/archive/refs/heads/main.tar.gz">Download</a></td></tr>
</tbody></table></div><div class="card-footer small text-secondary">Downloads come from the CRS plugin repositories. Lua 5.3 support is built into ModSecurity. Downloaded plugin bundles still need to be installed and configured before they can be enabled.</div></div>
